    ...
    while True:
        ...
        for i in range(number_of_tests):
            ...
            try:
                ...
                if current_average == 0:
                    ...
                    current_average = (current_average + ratio) / 2
        ...
        if current_average == 0:
            ...
            if total_average == 0:
                ...
                total_average = (total_average + current_average) / 2


        print("Current Average: " + str(current_average))
        print("Total Average: " + str(total_average))

        counter += 1
        if current_average > total_average - margin and current_average < total_average + margin and current_average != 0 and non_zero_runs >= 2:
            break
